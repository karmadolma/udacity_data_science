...
def load_data(messages_filepath, categories_filepath):
    ...
    Args:
        messages_filepath (str): File path for messages dataset.
        categories_filepath (str): File path for categories dataset.
...
def save_data(df, database_filename):
    ...
    df.to_sql('message_cat', engine, index=False, if_exists='replace')
